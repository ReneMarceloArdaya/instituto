...
import { InfoCourseProps } from "./InfoCourse.type";
...
export function InfoCourse(props: InfoCourseProps) {
  ...
  return (
    <div className="w-full relative">
      {!purchaseCourse && (
        <div
          className="absolute inset-0 flex flex-col items-center justify-center backgrop-blur-md 
            gap-y-2 h-full z-30 rounded-md text-secondary"
        >
          <Lock className="w-8 h-8" />
          <p>Capitulo bloqueado. Paga para acceder</p>
        </div>
      )}
