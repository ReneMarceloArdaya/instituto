import { CourseContentProps } from "./CourseContent.type";
    ...
    <div>
      ...
      <div className="space-y-6">
        {chapters.map((chapter, index) => (
          ...
          >
            <div
              className="flex-shrink-0 bg-violet-400 text-white font-semibold
            ...
            <div className="flex-shrink-0 flex items-center justify-center">
              ...
              >
                {chapter.isPublished ? "Publicado" : "Sin publicado"}
              </span>
            </div>
          </div>
        ))}
